 ...
 * desc：    TODO
 */
class SystemViewModel(application: Application) : BaseViewModel<SystemRepository>(application) {
    ...
    fun getArticle(cid: Int) {
        mRepository.getArticle(0, cid, mTreeArticleData)
    }
}